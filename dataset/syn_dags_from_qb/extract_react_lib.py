...
zinc_reactant_path = '/root/jupyter/DAG_Transformer/DAG_Transformer/dataset/raw/zinc'
ustpo_reagent_path = '/root/jupyter/DAG_Transformer/DAG_Transformer/dataset/syn_dag_from_qb/data/pretrain_reaction_dataset_add_change_idx.pkl'
output_dir = '/root/jupyter/DAG_Transformer/DAG_Transformer/dataset/syn_dag_from_qb/data/'
