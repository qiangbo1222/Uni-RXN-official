...
argparser.add_argument('--model_dir', type=str, default='/root/jupyter/DAG_Transformer/DAG_Transformer/pl_logs/set_gen_vae/epoch=358-step=123855.ckpt')
argparser.add_argument('--input_file', type=str, default='/root/jupyter/DAG_Transformer/DAG_Transformer/dataset/syn_dag_from_qb/data/react_lib_smi.pkl')
