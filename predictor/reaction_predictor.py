...
sys.path.append('/root/jupyter/DAG_Transformer/DAG_Transformer/predictor')
    ...
    def _run_list_of_reactant_sets(self, list_of_reactant_sets: typing.List[multiset.FrozenMultiset]) -> typing.List[multiset.Multiset]:
        ...
        def output_mapper(dict_in):
            ...
            for smi in prediction_split:
                try:
                    pred_res.append(canconicalize(smi))
                except Exception:
                    pass
        ...
        def select_input_if_op_none(input_, output_):
            ...
            if len(output_):
                ...
                return multiset.Multiset([0])# output None for fail prediction
...
predict_model._run_list_of_reactant_sets([set(['Cc1ncc(COP(=O)(O)O)c(C=O)c1O', 'COc1ccc(NN)cc1', 'CCO'])])
